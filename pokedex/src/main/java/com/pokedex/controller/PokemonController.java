...
public class PokemonController {
	...
	@PostMapping(path = "previousnext")
	public String showPokemons(@ModelAttribute PaginationDto pagination,Model model,@RequestParam(value ="action",required=true)String action) {
